...
funciones.darExcentricidadEx = function (Mx,cargaVertical) {
    var resultado =0;
    var lista = [];
    lista.length= 0;
    for (let i = 0; i < Mx.length; i++) {
        resultado = parseFloat(Mx[i]/cargaVertical[i]);
        //resultado = Math.round(resultado*100)/100;
        //console.log(i,"El resultado de momento actuante my: ",parseFloat(My[i]) ,"+", parseFloat(Fx[i]),"*", "(",h[i] ,"-", e[i],")","=", resultado);
        lista.push(resultado);
    }
...
funciones.darExcentricidadEy = function (My,cargaVertical) {
    var resultado =0;
    var lista = [];
    lista.length= 0;
    for (let i = 0; i < My.length; i++) {
        resultado = parseFloat(My[i]/cargaVertical[i]);
        //resultado = Math.round(resultado*100)/100;
        //console.log(i,"El resultado de momento actuante my: ",parseFloat(My[i]) ,"+", parseFloat(Fx[i]),"*", "(",h[i] ,"-", e[i],")","=", resultado);
        lista.push(resultado);
    }
...
funciones.darChequeoExcentricidadEx = function (Ex,Bx) {
    var resultado = String;
    var lista = [];
    lista.length= 0;
    for (let i = 0; i < Ex.length; i++) {
        console.log("EX: " + Ex[i])
        console.log("parseFloat(Bx[i]/6): " + parseFloat(Bx[i]/6))
        if (Ex[i] > parseFloat(Bx[i]/6)) {
        resultado = "Incrementar BX";
      }
      else{
        resultado = "OK";
      }
...
funciones.darChequeoExcentricidadEy = function (Ey,By) {
    ...
    for (let i = 0; i < Ey.length; i++) {
        console.log("EY: " + Ey[i])
        console.log("parseFloat(By[i]/6): " + parseFloat(By[i]/6))
        if (Ey[i] > parseFloat(By[i]/6)) {
        resultado = "Incrementar BY";
      }
      else{
        resultado = "OK";
      }
